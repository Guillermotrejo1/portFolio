...
export const Nav = () => {
  ...
  return (
    <nav className="flex justify-between items-center px-4 lg:max-w-[1280px] mb-4">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black z-40 flex items-center justify-center" onClick={handleClose}>
          <button className="absolute text-5xl top-10 right-4" onClick={handleClose}><IoMdClose /></button>
          <ul
